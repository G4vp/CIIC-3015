...
# Write a function called RLD() which takes a string that corresponds to the output from a Run Length Encoder as described above and returns the original, unencoded version of that string.
